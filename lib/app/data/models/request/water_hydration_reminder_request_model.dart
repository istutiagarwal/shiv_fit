...
@HiveType(typeId: HiveTypeIds.hydrationReminderRequestData)
class HydrationReminderRequestModel {
  @HiveField(0)
  ...
  @override
  String toString() => 'HydrationReminderRequestModel('
      'dateLabel: $dateLabel, '
  ...
  factory HydrationReminderRequestModel.fromJson(Map<String, dynamic> json) {
    return HydrationReminderRequestModel(
  ...
  HydrationReminderRequestModel copyWith({
    String? dateLabel,
    int? remindersMissed,
